...
export default function ResumeCard({
    ...
    return (
        <div className="flex items-start space-x-6 bg-blue-950/20 p-4 sm:p-8 rounded-md">
            <div className="w-10 h-10 sm:w-14 bg-blue-950 rounded-full grid place-items-center">
                <Icon className="w-6 h-6 sm:w-8 text-gray-200" />
            </div>
            <div className="flex-1">
                ...
                <p className="text-sm sm:text-base mt-3 text-gray-400 tracking-wide">{description}</p>
            </div>
        </div>
    )
}
