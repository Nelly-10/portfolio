...
const contactInfo = [
    {
        ...
        title: "Email",
        value: "odumahnelson@gmail.com",
        link: "malito:contact@john.dev",
    },

    {
        icon: <FaPhone className="w-6 h-6" />,
        title: "Phone",
        value: "(234) 7053241699",
        link: "tel:+1234567890",
    },
...
export default function ContactSection() {
    ...
    const onSubmit = async (event: React.FormEvent) => {
        ...
        formData.append("access_key", "600894b7-2328-4e11-a35f-db6f40e9a49c");
        ...
        <section id="contact" className="py-16 lg:py-30">
            <div className="w-[90%] md:w[80%] lg:w-[70%] mx-auto grid grid-cols-1 lg:grid-cols-2 gap-6 lg:gap-12">
                <div data-aos="fade-right">
                    ...
                    <p className="text-gray-400 mb-10 text-base lg:text-lg leading-relaxed">I&apos;m currently available for freelance work and full-time opportunities. Whether you have a project in mind or just want to connect, feel free to reach out.</p>
                            ...
                            contactInfo.map((item, index) => {
                                return (
                                    <Link href={item.link} key={index} className="group flex items-center gap-4 px-2 py-3 transition-colors hover:bg-white/5 rounded-lg">
                                        <div className="h-15 w-15 rounded-full bg-white/5 text-white transition-transform group-hover:105 grid place-items-center">
                                            {item.icon}
                                        </div>
...
// web3form
// 600894b7-2328-4e11-a35f-db6f40e9a49c
